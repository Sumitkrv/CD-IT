...
const CaseStudiesPreview = () => {
  const caseStudies = [
    ...
    },
    {
      ...
      gradient: 'from-green-50 to-emerald-100 dark:from-emerald-900/30 dark:to-emerald-800/20',
    ...
    },
    {
      ...
      gradient: 'from-violet-50 to-purple-100 dark:from-violet-900/30 dark:to-purple-800/20',
  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/20 mb-6">
          ...
          {caseStudies.map((study) => (
            ...
            >
              ...
              <div className="relative h-full">
                {/* Subtle shadow layer */}
                <div className="absolute inset-0 bg-gray-100 dark:bg-gray-800 rounded-xl transform translate-y-1" />
                
                {/* Main Card */}
                <div className="relative h-full bg-white dark:bg-gray-850 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-600">
                  ...
                  <div className={`h-40 relative overflow-hidden`}>
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-br ${study.gradient} mix-blend-multiply opacity-80`} />
                    {/* Darkening gradient for contrast */}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                    
                    <div className="absolute top-4 right-4">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white/95 dark:bg-gray-800/95 text-gray-700 dark:text-gray-300 backdrop-blur-sm shadow-sm">
                        {study.industry}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 italic mb-6 leading-relaxed">
                      {study.challenge}
                    </p>
                    ...
                    <div className="space-y-4 mb-8">
                      {study.results.map((result, index) => (
                        <div key={index} className="flex items-start">
                          ...
                          <div className="text-sm text-gray-600 dark:text-gray-300 leading-tight pl-4 border-l border-gray-200 dark:border-gray-700">
                            {result.label}
                          </div>
                        </div>
                      ))}
        ...
        >
          <Link to="/case-studies">
            <button className="px-8 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:border-gray-400 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 text-sm tracking-wide">
